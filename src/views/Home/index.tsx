    ...
    <Box maxW="100%" bg="#1B1A1C" color="#fff" >
      <Box bg={`#09090b url(${bannerBg}) left top no-repeat`} bgSize="100% 100%">
        <Box maxW={1200} margin="0 auto"  >
          ...
          <Flex p="0 10px" alignItems="center" justifyContent="space-between" h="80px">
            <Box flex={1} >
          ...
          <Center h={clientH - 100}>
            <Flex display={{ base: "none", md: "flex" }} w={{ base: "100%", md: 1200 }} alignItems="center" justifyContent="space-between" overflow="hidden">
              <Box w="100%" className="top_left" p="0 10px">
                <Heading as="h1" fontSize="80px" isTruncated>PENGUIN</Heading>
                <Text fontSize="40px" fontWeight="bold" mt="10px" >One-stop DeFi application platform</Text>
                <Text className="gray_text" mt="51px" fontSize="24px" lineHeight="40px">
                  Penguin is the automatic market-making protocol based on Solana.
                </Text>
                <PrimaryButton mt="88px" size="lg"><a href="#">Launch App</a></PrimaryButton>
              </Box>
      ...
      <Box w="100%" margin="0 auto" padding="0 10px" textAlign="center" position="relative" >
        <Box p="140px 0 100px 0">
          <Text fontSize="40px" fontWeight="bold">PENGUIN swap</Text>
          <Text className="gray_text" fontSize="18px" lineHeight="29px" mt="20px">
            PENGUIN adopts the mechanism of Automatic Market Maker (AMM) and aims to achieve self-driven liquidity creation.
          </Text>
        </Box>
        <Image src={areaBg} position="absolute" right="0" top={{ base: 350, md: 280 }} w="50%" h={{ base: "auto%", md: 280 }} />
        <Image src={homeBanner02} width="1200px" margin="0 auto" position="relative" />
      </Box>
      <Box h="96px" w="100%" position="relative" mt="-96px" bgGradient="linear-gradient(180deg,transparent 0%, #151a1d 61%)"></Box>

      <Box bg="#151A1D">
        <Flex maxW={1200} margin="0 auto" justifyContent="space-between" p={"250px 10px"} >
          ...
          <Box ml="100px" display={{ base: "none", xl: "block" }} >
            <Box p="20px 0">
              <Text fontSize="40px" fontWeight="bold">Safe fast and less slippage</Text>
              <Text className="gray_text" fontSize="18px" p="36px 0 60px 0">
            ...
            <List spacing={30}>
              <ListItem className={activeItem === 1 ? "safe_item safe_item_active" : "safe_item"} onClick={() => onItemChange(1)}   >
                <Flex alignItems="center" justifyContent="flex-start" p="25px 36px" bg="#1f2326" borderRadius="20px" >
                  <Image src={item01} width="50px" />
                  <Text ml="20px" fontSize="16px" lineHeight="1">In Solana, use a far more granular verifiable delay function, a SHA 256 hash chain, to checkpoint the ledger and coordinate consensus.</Text>
                </Flex>
              </ListItem>
              ...
              <ListItem className={activeItem === 2 ? "safe_item safe_item_active" : "safe_item"} onClick={() => onItemChange(2)}   >
                <Flex alignItems="center" justifyContent="flex-start" p="25px 36px" bg="#1f2326" borderRadius="20px" >
                  ...
                  <Text ml="20px" fontSize="16px">The resulting cluster wouldn"t be just 10 times faster, or a 100 times, or a 1,000 times, but 10,000 times faster, right out of the gate!</Text>
                </Flex>
              </ListItem>
              ...
              <ListItem className={activeItem === 3 ? "safe_item safe_item_active" : "safe_item"} onClick={() => onItemChange(3)}   >
                <Flex alignItems="center" justifyContent="flex-start" p="25px 36px" bg="#1f2326" borderRadius="20px" >
                  ...
                  <Text ml="20px" fontSize="16px">lowest platform transaction fees，user can save more</Text>
                </Flex>
              </ListItem>
        ...
        <Box bg="#151A1D" maxW={1200} margin="0 auto" p="10px" textAlign="center" >
          <Box>
            <Text fontSize="40px" fontWeight="bold">Features</Text>
            <Text className="gray_text" fontSize="18px" mt="20px">
              What we listed and under construction
            </Text>
          </Box>

          <Flex justifyContent="space-between" p={{ base: "50px 0 ", md: "150px 0" }}  >
            <Box w={{ base: "30%", md: 200 }}>
              <Image src={row01} borderRadius="20px" width="140px" margin="0 auto" className="feedback_up" />
            ...
            <Box w={{ base: "30%", md: 200 }} >
              <Image src={row02} borderRadius="20px" width="140px" margin="0 auto" className="feedback_up" />
              <Box textAlign="center">
            ...
            <Box w={{ base: "30%", md: 200 }}>
              <Image src={row03} borderRadius="20px" width="140px" margin="0 auto" className="feedback_up" />
              <Box textAlign="center">
      ...
      <Box bg={`#09090b url(${bannerBg}) left top no-repeat`} bgSize="100% 100%">
        {/* bgGradient="linear-gradient(30deg, #000 5%, #182c33 15%, #11412f 20%, #11412f 30%, #000 60%)"  */}
        <Box pt="150px">
          <Center><Text fontSize="40px" fontWeight="bold" textAlign="center">Join us and let's PNG</Text></Center>
          <Center><Text className="gray_text" fontSize="18px" textAlign="center">gives users the ability to swap, provide liquidity, farm to gain system.</Text></Center>
          <Center p="38px 0 85px 0"><PrimaryButton size="lg"><a href="#">Launch App</a></PrimaryButton></Center >
        </Box>
        <Box h="50px" w="100%" bgGradient="linear-gradient(-180deg,transparent,#000 70%)"></Box>

        <Box bg="#000" p="100px 0 150px 0">
            ...
            <Flex flexDirection={{ base: "column", md: "row" }} justifyContent="space-between">
              ...
              <Flex flex="1" margin={{ base: "40px 0", md: 0 }} p="0 20px" justifyContent={{ base: "space-between", md: "space-around" }}>
                ...
                >
                  ...
                  <Box fontWeight="bold" fontSize="18px" color="#fff" mb="10px">App</Box>
                  <Link>Swap</Link>
                  <Link>Pools</Link>
                  <Link>Stake</Link>
                </VStack>
                ...
                <VStack
                  ...
                  className="bottom_links"
                >
                  <Box fontWeight="bold" fontSize="18px" color="#fff" mb="10px">Resources</Box>
                  <Link>Docs</Link>
                  <Link>Github</Link>
                  <Link>Coingecko</Link>
                </VStack>
                ...
                <VStack
                  ...
                  className="bottom_links"
                >
                  <Box fontWeight="bold" fontSize="18px" color="#fff" mb="10px">Connect</Box>
                  <Link>Blog </Link>
                  <Link>Twitter</Link>
                  <Link>Discord</Link>
                </VStack>
              ...
              <Flex>
                <Link className="bottom_icon bottom01 feedback_links_up"></Link>
                <Link className="bottom_icon bottom02 feedback_links_up"></Link>
                <Link className="bottom_icon bottom03 feedback_links_up"></Link>
              </Flex>
